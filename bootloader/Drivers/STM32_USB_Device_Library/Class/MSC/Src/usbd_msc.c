...
/*
 * Xavier Hosxe / preenfm3 note
 * USB buffer must be in R2b
 */
__attribute__((section(".ram_d2b")))  USBD_MSC_BOT_HandleTypeDef r2bMem;
                         ...
                         uint8_t cfgidx)
{
  ...
  if (pdev->pClassData != NULL)
  {
    // preenfm3 cannot free it's static memory
