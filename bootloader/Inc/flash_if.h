...
// Preenfm3 optional other applications that the bootloader can jump to
#define APPLICATION2_ADDRESS   (uint32_t)0x08180000
#define APPLICATION3_ADDRESS   (uint32_t)0x081c0000
